<template>
  <div style="flex-direction: row; display: flex; padding: 0">
      <div
        style="width: 124px; height: 124px; display: flex; justify-content: space-between;"
      ...
      <ion-skeleton-text style="width: 124px; height: 124px;" v-else :animated="!story" />
      <div style="display: flex; flex-direction: column; margin-left: 1rem; font-size: 12px">
        <template v-if="story">
        ...
        align-items: center;">
            ...
            <div style="line-height: 20px; display: flex;
        align-items: center;">
            <ion-icon :icon="documentOutline" style="margin-right: 4px;"></ion-icon>
        ...
        <template v-else>
            <ion-skeleton-text style="width: 200px; height: 20px; margin-bottom: 0.5rem;" :animated="true" />
            <ion-skeleton-text style="width: 100px; height: 20px; margin-bottom: 0.5rem;" :animated="true" />
            <ion-skeleton-text style="width: 100px; height: 20px; margin-bottom: 0.5rem;" :animated="true" />
            <ion-skeleton-text style="width: 100px; height: 20px; margin-bottom: 0.5rem;" :animated="true" />
        </template>
      </div>
