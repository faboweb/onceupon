module.exports = (function () {
  ...
  define("stargaze", ["require", "exports"], function (require, exports) {
    ...
    exports.loadOwnedNftsForAddress = exports.loadNft = void 0;
    ...
    function loadOwnedNftsForAddress(address) {
      return __awaiter(this, void 0, void 0, function () {
        var tokens;
        return __generator(this, function (_a) {
          switch (_a.label) {
    ...
    exports.loadOwnedNftsForAddress = loadOwnedNftsForAddress;
  });
  ...
  function resolve(name) {
    ...
    instances[name] = {};
    var dependencies = define.dependencies.map(function (name) {
      return resolve(name);
    });
